...
import { RequestData, Response, ResponseData, request, url } from './requests/fetch-rules'
...
export function useFetchRulesList<TData = ResponseData>(
  requestData: RequestData,
  preferedOptions?: Options<TData>
): QueryResult<TData> {
  const keys: Keys = [url, useFetchRulesList.name, requestData]
